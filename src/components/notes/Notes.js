          ...
          <div className="w-full flex flex-col">
            <div className="">
              <div className="px-8 pt-8 bg-primary-100 flex flex-col">
                <input id="document-title" autoComplete="off" className="h-12 bg-transparent text-primary-800 font-bold outline-none text-4xl mb-4" placeholder="Untitled" type="text" aria-label="document title"></input>
                <TagList />
