...
export default function PageReminders() {
  ...
  return (
    <div className={`bg-primary-700 fixed top-0 bottom-0 h-full text-white p-4 xl:w-96 lg:w-72 w-48 flex flex-col`}>
      <div
        className={
          "bg-primary-600 w-full h-10 rounded-md flex items-center z-10"}>
        <i>
