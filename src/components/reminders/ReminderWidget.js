...
export default function ReminderWidget({ icon, title, amount }) {
  return (
    <div className="hover:bg-primary-500 bg-primary-600 w-full h-auto py-1 rounded-md text-center xl:flex-1">
      <div className="m-1 my-2 h-auto flex">
        ...
        <div className="relative flex-auto">
          <div className="absolute right-0 w-auto flex h-full">
            <p className="my-auto mr-2 text-lg text-accent-400 font-semibold">{amount}50</p>
          </div>
        </div>
      </div>
    </div>
