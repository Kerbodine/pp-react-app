    ...
    <ul
      className={`overflow-y-auto overflow-hidden list-none fixed top-0 right-0 bottom-0 flex flex-col h-full bg-primary-800 text-white transition-width z-10 ${
        ...
        <li className="mx-4 mt-24">
          ...
          <p className={`mb-2 text-xl font-semibold ${isSideExpanded ? "visible" : "hidden"}`}>Calendar:</p>
        ...
        <li className="mx-4 mt-4">
          ...
          <p className={`text-xl font-semibold ${isSideExpanded ? "visible" : "hidden"}`}>Upcoming events:</p>
        </li>
        ...
        <li className="mx-4 mt-4">
          <p className={`text-xl font-semibold ${isSideExpanded ? "visible" : "hidden"}`}>Pinned tasks:</p>
        ...
        <li className="mx-4 mt-4">
          ...
          <p className={`mb-2 text-xl font-semibold ${isSideExpanded ? "visible" : "hidden"}`}>Stickies:</p>
          <SideStickie isSideExpanded={isSideExpanded}/>
        </li>
    </ul>
  );
}
