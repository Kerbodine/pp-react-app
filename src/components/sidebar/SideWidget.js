...
export default function SideWidget({ isSideExpanded, eventName, countdown, timeUnit }) {
  return (
    <div className={`transition opacity my-2 hover:bg-primary-600 bg-primary-700 w-1/2 h-auto rounded flex justify-center text-center ${ isSideExpanded ? "visible" : "hidden"}`}>
